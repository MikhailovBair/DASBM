...
class NCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    log_architecture_NCSNpp = f"NCSNpp, nz = {config.nz}, z_emb_dim = {z_emb_dim}, " \
                              f"num_channels_dae = {config.num_channels_dae}, ch_mult = {ch_mult}, " \
                              f"n_mlp = {config.n_mlp}, num_res_blocks = {num_res_blocks}, " \
                              f"attn_resolutions = {self.attn_resolutions}"
    print(log_architecture_NCSNpp)
